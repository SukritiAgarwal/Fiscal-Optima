	...
	if(isset($_POST['submit'])){
		...
		if($date!="" && $amount!="" && $description!="" && $customer!=""){
			...
			if(mysqli_query($conn,$sql)){
				...
				echo 'alert("Successfully added the payment made to the database!")';
				echo '</script>';
				header("location:paymentsmade.php?var='$email'");
			}
			else{
				echo '<script language="javascript">';
   ...
   <body>
      <div id="container">
         ...
         <div id="nav">
            ...
            <form action="paymentsmade.php" method="POST">
...
<div class="formcontainer">
  <form action="paymentsmade.php?var=<?php echo $email?>" method="POST" >
...
<br>
    <input type="text" id="text" name="To">
<br>
